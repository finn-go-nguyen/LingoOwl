...
mixin _$HomeNavigationItem {
  LRoutes get route => throw _privateConstructorUsedError;
...
class _$_HomeNavigationItem implements _HomeNavigationItem {
  ...
  @override
  String toString() {
    return 'HomeNavigationItem(route: $route, path: $path, icon: $icon, selectedIcon: $selectedIcon, tooltip: $tooltip, label: $label, view: $view)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, route, path, icon, selectedIcon, tooltip, label, view);
